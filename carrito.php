                        ...
                        <div class="woocommerce">
                                <div class="table-responsive">
                                    <table cellspacing="0" class="shop_table cart">
                                        <thead>
                                            <tr>
                                                <th class="product-thumbnail"><i class="fa " aria-hidden="true"></i> Foto</th>
                                                <th class="product-name"><i class="fa art" aria-hidden="true"></i> Producto</th>
                                                <th class="product-price"><i class="fa " aria-hidden="true"></i> Precio</th>
                                                <th class="product-quantity">Cantidad</th>
                                                <th class="product-subtotal"><i class="fa " aria-hidden="true"></i> Total</th>
                                                <th><i class="fa " aria-hidden="true"></i> Cantidad</th>
                            ...
                            <div class="cart-collaterals wow fadeIn">
                                ...
                                <div class="cart_totals col-sm-6 col-xs-12">
                                    <h2>Precico de tu equipo</h2>

                                    <table cellspacing="0">
                                        <tbody>                                           
                                            <tr class="order-total">
                                                <th>Total </th>
                                                <td><strong><span class="amount">Bs<?php echo number_format($total = $subtotal+$iva, 0, ',', '.');?></span></strong> </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <form id="form1" method="post" action="reportes/reporte.php">
                                                        <input type="submit" name="button" id="button" value="inprimir precio" class="btn btn-success">
                                                    </form>
                                                </td>
                                            </tr>
                                        </tbody>
