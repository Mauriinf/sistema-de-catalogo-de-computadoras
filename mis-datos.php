...
<?php
	if($_POST[enviar] == "Modificar"){
		echo $q="UPDATE `clientes` SET `email` = '$_POST[email]', `telefono` = '$_POST[telefono]', `nacionalidad` = 'bolivia', `direccion` = '$_POST[direccion]', `numero` = '$_POST[numero]', `comuna` = '$_POST[comuna]', `contrasena` = '$_POST[contrasena]' WHERE `clientes`.`id` = $_POST[id];";
